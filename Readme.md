...
>:info:
> The sample application is used to explore different AI tools and techniques. Don't focus too much on the implementation details of the application itself and don't worry if some parts are not fully functional. 
